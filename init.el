...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#25292C" :foreground "#A4A5A6" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 145 :width normal :foundry "nil" :family "Source Code Pro"))))
 ...
 '(dired-header ((t (:foreground "#eac15a"))))
 ...
 '(font-lock-constant-face ((t (:foreground "#EAC15A"))))
 '(font-lock-keyword-face ((t (:foreground "#EAC15A"))))
 '(font-lock-string-face ((t (:foreground "#DE8F4A"))))
 '(font-lock-type-face ((t (:foreground "#DE8F4A"))))
 '(font-lock-variable-name-face ((t (:foreground "#82A25F"))))
